...
OnvifServiceDevice.prototype.getCapabilities = function(callback) {
	...
	mOnvifSoap.requestCommand(this.oxaddr, 'GetCapabilities', soap, function(error, result) {
...
OnvifServiceDevice.prototype.getWsdlUrl = function(callback) {
	...
	mOnvifSoap.requestCommand(this.oxaddr, 'GetWsdlUrl', soap, function(error, result) {
		callback(error, result);
	});
};
...
OnvifServiceDevice.prototype.getDiscoveryMode = function(callback) {
	...
	mOnvifSoap.requestCommand(this.oxaddr, 'GetDiscoveryMode', soap, function(error, result) {
		callback(error, result);
	});
};
...
OnvifServiceDevice.prototype.getScopes = function(callback) {
	...
	mOnvifSoap.requestCommand(this.oxaddr, 'GetScopes', soap, function(error, result) {
		callback(error, result);
	});
};
...
OnvifServiceDevice.prototype.setScopes = function(params, callback) {
	...
	scope_list.forEach(function(s) {
		soap_body += '<tds:Scopes>' + s + '</tds:Scopes>';
	});
	soap_body += '</tds:SetScopes>';
	var soap = this._createRequestSoap(soap_body);

	mOnvifSoap.requestCommand(this.oxaddr, 'SetScopes', soap, function(error, result) {
		callback(error, result);
	});
};
...
OnvifServiceDevice.prototype.addScopes = function(params, callback) {
	...
	mOnvifSoap.requestCommand(this.oxaddr, 'AddScopes', soap, function(error, result) {
		callback(error, result);
	});
};
...
OnvifServiceDevice.prototype.removeScopes = function(params, callback) {
	...
	mOnvifSoap.requestCommand(this.oxaddr, 'RemoveScopes', soap, function(error, result) {
		callback(error, result);
	});
};
...
OnvifServiceDevice.prototype.getHostname = function(callback) {
	...
	mOnvifSoap.requestCommand(this.oxaddr, 'GetHostname', soap, function(error, result) {
		callback(error, result);
	});
};
...
OnvifServiceDevice.prototype.setHostname = function(params, callback) {
	...
	mOnvifSoap.requestCommand(this.oxaddr, 'SetHostname', soap, function(error, result) {
		callback(error, result);
	});
};
...
OnvifServiceDevice.prototype.getDNS = function(callback) {
	...
	mOnvifSoap.requestCommand(this.oxaddr, 'GetDNS', soap, function(error, result) {
		if(!error) {
			try {
...
OnvifServiceDevice.prototype.setDNS = function(params, callback) {
	...
	mOnvifSoap.requestCommand(this.oxaddr, 'SetDNS', soap, function(error, result) {
		callback(error, result);
	});
};
...
OnvifServiceDevice.prototype.getNetworkInterfaces = function(callback) {
	...
	mOnvifSoap.requestCommand(this.oxaddr, 'GetNetworkInterfaces', soap, function(error, result) {
		callback(error, result);
	});
};
...
OnvifServiceDevice.prototype.getNetworkProtocols = function(callback) {
	...
	mOnvifSoap.requestCommand(this.oxaddr, 'GetNetworkProtocols', soap, function(error, result) {
		callback(error, result);
	});
};
...
OnvifServiceDevice.prototype.setNetworkProtocols = function(params, callback) {
	...
	soap_body += '</tds:SetNetworkProtocols>';
	var soap = this._createRequestSoap(soap_body);
	mOnvifSoap.requestCommand(this.oxaddr, 'SetNetworkProtocols', soap, function(error, result) {
		callback(error, result);
	});
};
...
OnvifServiceDevice.prototype.getNetworkDefaultGateway = function(callback) {
	...
	mOnvifSoap.requestCommand(this.oxaddr, 'GetNetworkDefaultGateway', soap, function(error, result) {
		callback(error, result);
	});
};
...
OnvifServiceDevice.prototype.setNetworkDefaultGateway = function(params, callback) {
	...
	mOnvifSoap.requestCommand(this.oxaddr, 'SetNetworkDefaultGateway', soap, function(error, result) {
		callback(error, result);
	});
};
...
OnvifServiceDevice.prototype.getDeviceInformation = function(callback) {
	...
	mOnvifSoap.requestCommand(this.oxaddr, 'GetDeviceInformation', soap, function(error, result) {
		callback(error, result);
	});
};
...
OnvifServiceDevice.prototype.getSystemDateAndTime = function(callback) {
	...
	mOnvifSoap.requestCommand(this.oxaddr, 'GetSystemDateAndTime', soap, function(error, result) {
		if(!error) {
...
OnvifServiceDevice.prototype.setSystemDateAndTime = function(params, callback) {
	...
	mOnvifSoap.requestCommand(this.oxaddr, 'SetSystemDateAndTime', soap, function(error, result) {
		callback(error, result);
	});
};
...
OnvifServiceDevice.prototype.reboot = function(callback) {
	...
	mOnvifSoap.requestCommand(this.oxaddr, 'SystemReboot', soap, function(error, result) {
		callback(error, result);
	});
};
...
OnvifServiceDevice.prototype.getUsers = function(callback) {
	...
	mOnvifSoap.requestCommand(this.oxaddr, 'GetUsers', soap, function(error, result) {
		if(!error) {
			try {
...
OnvifServiceDevice.prototype.createUsers = function(params, callback) {
	...
	mOnvifSoap.requestCommand(this.oxaddr, 'CreateUsers', soap, function(error, result) {
		callback(error, result);
	});
};
...
OnvifServiceDevice.prototype.deleteUsers = function(params, callback) {
	...
	mOnvifSoap.requestCommand(this.oxaddr, 'DeleteUsers', soap, function(error, result) {
		callback(error, result);
	});
};
...
OnvifServiceDevice.prototype.setUser = function(params, callback) {
	...
	mOnvifSoap.requestCommand(this.oxaddr, 'SetUser', soap, function(error, result) {
		callback(error, result);
	});
};
...
OnvifServiceDevice.prototype.getRelayOutputs = function(callback) {
	...
	mOnvifSoap.requestCommand(this.oxaddr, 'GetRelayOutputs', soap, function(error, result) {
		callback(error, result);
	});
};
...
OnvifServiceDevice.prototype.getNTP = function(callback) {
	...
	mOnvifSoap.requestCommand(this.oxaddr, 'GetNTP', soap, function(error, result) {
		callback(error, result);
	});
};
...
OnvifServiceDevice.prototype.setNTP = function(params, callback) {
	...
	mOnvifSoap.requestCommand(this.oxaddr, 'SetNTP', soap, function(error, result) {
		callback(error, result);
	});
};
...
OnvifServiceDevice.prototype.getDynamicDNS = function(callback) {
	...
	mOnvifSoap.requestCommand(this.oxaddr, 'GetDynamicDNS', soap, function(error, result) {
		callback(error, result);
	});
};
...
OnvifServiceDevice.prototype.getZeroConfiguration = function(callback) {
	...
	mOnvifSoap.requestCommand(this.oxaddr, 'GetZeroConfiguration', soap, function(error, result) {
		callback(error, result);
	});
};
...
OnvifServiceDevice.prototype.getIPAddressFilter = function(callback) {
	...
	mOnvifSoap.requestCommand(this.oxaddr, 'GetIPAddressFilter', soap, function(error, result) {
		callback(error, result);
	});
};
...
OnvifServiceDevice.prototype.setIPAddressFilter = function(params, callback) {
	...
	mOnvifSoap.requestCommand(this.oxaddr, 'SetIPAddressFilter', soap, function(error, result) {
		callback(error, result);
	});
};
...
OnvifServiceDevice.prototype.getServices = function(params, callback) {
	...
	mOnvifSoap.requestCommand(this.oxaddr, 'GetServices', soap, function(error, result) {
		callback(error, result);
	});
};
...
OnvifServiceDevice.prototype.getServiceCapabilities = function(callback) {
	...
	mOnvifSoap.requestCommand(this.oxaddr, 'GetServiceCapabilities', soap, function(error, result) {
		callback(error, result);
	});
};
