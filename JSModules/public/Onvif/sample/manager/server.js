...
function startDiscovery(conn) {
	devices = {};
	var names = {};
	onvif.startDiscovery(function(device) {
...
function connect(conn, params) {
	...
	device.init(function(error, result) {
		var res = {'id': 'connect'};
		if(error) {
...
function fetchSnapshot(conn, params) {
	...
	device.fetchSnapshot(function(error, result)  {
...
function ptzMove(conn, params) {
	...
	device.ptzMove(params, function(error)  {
		var res = {'id': 'ptzMove'};
		if(error) {
			res['error'] = error.toString();
		} else {
...
function ptzHome(conn, params) {
	...
	ptz.gotoHomePosition(params, function(error, result)  {
		var res = {'id': 'ptzMove'};
		if(error) {
			res['error'] = error.toString();
		} else {
