...
var gatewayip = '10.0.0.30';
var gatewayport = '5004';
...
function start() {
   // myconsole.log(debug);
	...
	if(io)
	{ myconsole.log('ESP8266 Module Listening on ' + '44606');}
	

	
	io.sockets.on('connection', function(socket){
	  myconsole.log('Client connected to ESP8266 Parser');
		...
		function processData(data){
	    	...
	    	if(data[2] == 3){
		  	...
		  	function connect(){
		  		myconsole.log('Mysensors: Trying to connect to ESP8266 @ ' + gatewayip + ':' + gatewayport);
		  		
					actual.connect({port: gatewayport, host:gatewayip}, function() {
					    myconsole.log('Mysensors: ESP8266 connected');
